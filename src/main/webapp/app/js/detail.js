...
*/
  ...
  var detailUrl = commonUrl + 'discovery/cms/listInfo/';
  var id = localStorage.getItem('detailId')|| '1/1';
  $.get(detailUrl+id, function (data) {
...
},{"detector":3}],2:[function(require,module,exports){
